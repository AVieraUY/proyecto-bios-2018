...
@numero int
as
if (not exists (select * from Pedido where numero = @numero)) -- devoler estado y cargar en una variable
return -1
...
@num int
as
if((select estado from Pedido where numero = @num ) ='entregado') --idem  eliminar pedido
return -1
...
-- son 2 sp de login uno por cada tipo de usuario
